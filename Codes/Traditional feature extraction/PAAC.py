...
def PAAC(fastas, lambdaValue=20, w=0.05, **kw):
    ...
    dataFile = 'D:\VF_data\DATA\supp_file\PAAC.txt'
...
#AADict = {'A': 0, 'R': 1, 'N': 2, ..., 'W': 17, 'Y': 18, 'V': 19}
#AAProperty = [[0.62,..., 1.08], [-0.5, ..., -1.5], [15.0,..., 43.0]]
#AAPropertyNames = ['Hydrophobicity', 'Hydrophilicity', 'SideChainMass']
